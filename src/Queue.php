...
class Queue extends \Sinevia\ActiveRecord
{
    ...
    public static function tableCreate()
    {
        ...
        static::getDatabase()->table(static::$table)
            ...
            ->column('LinkedIds', 'STRING', 'DEFAULT NULL')
            ->column('Parameters', 'TEXT', 'DEFAULT NULL')
            ->column('Output', 'TEXT', 'DEFAULT NULL')
            ->column('Details', 'TEXT', 'DEFAULT NULL')
     ...
     */
    public static function processQueuedTaskById($queuedId)
    {
